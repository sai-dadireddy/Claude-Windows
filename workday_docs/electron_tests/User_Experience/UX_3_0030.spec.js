...
test.describe('User Experience - UX-3-0030', () => {
  let api;
  ...
  test('Workday Assistant', async () => {
    ...
    // 2. Execute: Domain: Assistant; Edit Tenant Setup - Assistant
 ...
 *
 * Task Details:
 * Domain: Assistant; Edit Tenant Setup - Assistant
 *
 * Step Details:
