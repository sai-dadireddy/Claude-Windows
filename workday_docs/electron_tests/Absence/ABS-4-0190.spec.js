/**
 * Electron Test: ABS-4-0190 - Return from Leave of Absence - Unpaid (PI)
...
test.describe('ABS-4-0190: Return from Leave of Absence - Unpaid (PI)', () => {
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Absence Return from Leave of Absence - Unpaid (PI) None
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
 * ## Results for: Absence Return from Leave of Absence - Unpaid (PI) None
 * 
