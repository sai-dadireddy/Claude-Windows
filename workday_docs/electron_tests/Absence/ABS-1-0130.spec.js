/**
 * Electron Test: ABS-1-0130 - Absence Worklet
 ...
 * Proxy as an Employee as Self worker. Ensure 'Absence' Worklet is available to the employee and contains the appropriate tasks/reports. Alternatively, review the following worklet: Time Off.
 *
...
test.describe('ABS-1-0130: Absence Worklet', () => {
