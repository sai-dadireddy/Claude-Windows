/**
 * Electron Test: ABS-4-0270 - Review Accruals (Payroll impact)
 ...
 * ** Only applies if accruals are dependent on hours worked from Payroll ** Enter time for a worker and review time off accrual. Review impact of deleting time entries and adding new time entries in payroll. Enter time start of period, mid period, end of period
Review accrual when payroll is in progress vs completed
 *
...
test.describe('ABS-4-0270: Review Accruals (Payroll impact)', () => {
  ...
  test('Execute: 1. Review time off balance for worker', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Absence Review Accruals (Payroll impact) 1. Review time off balance for worker
    // 
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Absence Review Accruals (Payroll impact) 1. Review time off balance for worker
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
