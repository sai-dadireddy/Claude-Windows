/**
 * Electron Test: ABS-4-0070-03 - Unpaid Time Off to Payroll
 ...
 * Review pay calculation results. Ensure that for salaried employees the unpaid time off reduces the gross (and hours pay component related calculations) and for hourly employees the unpaid time off does not have any impact on the gross (and hours pay component related calculations).
 *
...
test.describe('ABS-4-0070-03: Unpaid Time Off to Payroll', () => {
  ...
  test('Execute: 3. Payroll Review', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Absence Unpaid Time Off to Payroll 3. Payroll Review
    // 
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Absence Unpaid Time Off to Payroll 3. Payroll Review
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
