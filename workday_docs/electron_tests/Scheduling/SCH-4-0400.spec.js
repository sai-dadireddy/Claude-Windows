/**
 * Electron Test: SCH-4-0400 - Static Scheduling - Generate Schedule - 5 work days (weekly Work Schedule) as Scheduling Partner/ Admin for Employee
...
test.describe('SCH-4-0400: Static Scheduling - Generate Schedule - 5 work days (weekly Work Schedule) as Scheduling Partner/ Admin for Employee', () => {
  ...
  test('Execute: Static Scheduling', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Scheduling Static Scheduling - Generate Schedule - 5 work days (weekly Work Schedule) as Scheduling Partner/ Admin for Employee Static Scheduling
    // 
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Scheduling Static Scheduling - Generate Schedule - 5 work days (weekly Work Schedule) as Scheduling Partner/ Admin for Employee Static Scheduling
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
