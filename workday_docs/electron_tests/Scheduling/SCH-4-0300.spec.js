/**
 * Electron Test: SCH-4-0300 - Static Scheduling - EIB for Assign Work Schedule to Worker
 ...
 * Login as a Scheduling Admin and use EIB to assign Work Schedules.
 *
...
test.describe('SCH-4-0300: Static Scheduling - EIB for Assign Work Schedule to Worker', () => {
  ...
  test('Execute: Static Scheduling', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Scheduling Static Scheduling - EIB for Assign Work Schedule to Worker Static Scheduling
    // 
    // ### 1. WSDL: Scheduling (score: 9)
    ...
    //   - Get_Scheduling_Settings: Returns settings...
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Scheduling Static Scheduling - EIB for Assign Work Schedule to Worker Static Scheduling
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
