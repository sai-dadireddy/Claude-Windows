/**
 * Electron Test: SCH-2-0100 - Change Schedule Tag Assignment
 ...
 * As a Scheduling Administrator/Scheduling Partner/Manager: Edit Schedule Tags for a worker.
 *
...
test.describe('SCH-2-0100: Change Schedule Tag Assignment', () => {
  ...
  test('Execute: Assign Schedule Tags to Worker', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Scheduling Change Schedule Tag Assignment Assign Schedule Tags to Worker
    // 
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Scheduling Change Schedule Tag Assignment Assign Schedule Tags to Worker
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
 ...
 * ```
 * 
 * ### 2. Workday Feature Descriptions Ditamap (score: 9)
