/**
 * Electron Test: SCH-4-0480 - Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 2 as Manager
...
Confirm that schedule is created as expected for week 2.
...
test.describe('SCH-4-0480: Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 2 as Manager', () => {
  ...
  test('Execute: Static Scheduling', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Scheduling Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 2 as Manager Static Scheduling
    // 
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Scheduling Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 2 as Manager Static Scheduling
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
