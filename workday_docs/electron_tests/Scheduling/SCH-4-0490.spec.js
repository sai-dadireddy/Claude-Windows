/**
 * Electron Test: SCH-4-0490 - Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 3 as Manager
...
Confirm that schedule is created as expected for week 3.
...
test.describe('SCH-4-0490: Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 3 as Manager', () => {
  ...
  test('Execute: Static Scheduling', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Scheduling Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 3 as Manager Static Scheduling
    // 
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Scheduling Static Scheduling - Generate Schedule - Rotating Shift (xxxx) Week 3 as Manager Static Scheduling
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
