/**
 * Electron Test: SCH-2-0350 - Worker Overrides
 ...
 * Update Minimum Rest Between Shifts for one of the employees that is being tested using Change Worker Overrides task
 *
...
test.describe('SCH-2-0350: Worker Overrides', () => {
