/**
 * Electron Test: SCH-2-0370 - Worker Overrides
 ...
 * Update Maximum Weekly Hours for one of the employees that is being tested using Change Worker Overrides task
 *
...
test.describe('SCH-2-0370: Worker Overrides', () => {
