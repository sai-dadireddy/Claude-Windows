/**
 * Electron Test: SCH-2-0320 - Change Work Availability for Worker
 ...
 * Change the Times for one the days on the Availability - Say, Tuesday
 *
...
test.describe('SCH-2-0320: Change Work Availability for Worker', () => {
