/**
 * Electron Test: SCH-2-0550 - Publish Schedule Business Process User Group
 ...
 * Confirm the correct user group has access to Publish the schedule
 *
 * Task/Step: None
...
test.describe('SCH-2-0550: Publish Schedule Business Process User Group', () => {
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Scheduling Publish Schedule Business Process User Group None
 * Results:
 * Loaded 63 docs from public/private
 * Loaded 55 WSDLs with 3169 operations
 * Total: 118 documents
 * ## Results for: Scheduling Publish Schedule Business Process User Group None
 * 
