/**
 * Electron Test: SCH-2-0230 - Breaks
 ...
 * The solver would count break time towards scheduled hours and cost for each scheduling organization. Please confirm that this is how you would expect the solver to handle the paid breaks, by including the paid break time in the total scheduled hours and total cost.
 *
...
test.describe('SCH-2-0230: Breaks', () => {
...
3. Schedule Workers through Time and Scheduling Hub', async ({ page }) => {
    ...
    // Total: 118 documents
    // ## Results for: Scheduling Breaks 1. View Meal Break Ruleset 
    // 2. Edit Scheduling Settings 
    // 3. Schedule Workers through Time and Scheduling Hub
    // 
    // ### 1. Admin Guide Authentication And Security (score: 14)
 ...
 * RAG REFERENCE DATA:
 *
 * Query: Scheduling Breaks 1. View Meal Break Ruleset 
2. Edit Scheduling Settings 
3. Schedule Workers through Time and Scheduling Hub
 * Results:
 * Loaded 63 docs from public/private
