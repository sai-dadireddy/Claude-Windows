/**
 * Electron Test: SCH-2-0150 - Validations
 ...
 * If the maximum shift length is configured, confirm the shifts generated on the schedule reflect that maximum shift length.
  
  For example: Maximum shift length configured is 10 hours. Confirm a validation appears when the employee gets a shift for 11 hours.
 *
...
test.describe('SCH-2-0150: Validations', () => {
