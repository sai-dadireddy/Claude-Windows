...
# Test Steps
describe "BA-4-0170-01 - Reinstate Asset" do
  ...
  it "should complete: Reinstate Asset" do
    ...
    enter search box as "1. Reinstate an asset"
    wait for search results
    click search result containing "1. Reinstate an asset"
    wait for page to load

    # Step 2: Execute task
    # [NEEDS SME INPUT] - Define specific actions for: 1. Reinstate an asset

    # Step 3: Validation
    verify task completed successfully
    screenshot as "BA-4-0170-01_complete.png"
