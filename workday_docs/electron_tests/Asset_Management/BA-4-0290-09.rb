# BA-4-0290-09 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)
...
describe "BA-4-0290-09 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)" do
  ...
  it "should complete: Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)" do
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0290-09_complete.png"
  end
