# BA-4-0310-01 - Leases: Short Term Operating Lease
# Confidence Score: 7.0/10.0
# Functional Area: Asset Management
# Role: Supplier Contract Specialist

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Create a Supplier Contract for an operating lease with a contract term less than one year.

# Test Steps
describe "BA-4-0310-01 - Leases: Short Term Operating Lease" do
  ...
  it "should complete: Leases: Short Term Operating Lease" do
    ...
    screenshot as "BA-4-0310-01_created.png"
  end
