# BA-4-0220-10 - Leases: Supplier Contract
...
## Test Information
- **Scenario ID**: BA-4-0220-10
- **Functional Area**: Asset Management
- **Role**: Supplier contract specialist
- **Task**: nan

## Manual Test Steps
1. Login as: Supplier contract specialist
2. Navigate to: nan
3. Execute: Create lease supplier Contract Amendment (payment change)
4. Sub-Task: Verify changes in the values are correct
