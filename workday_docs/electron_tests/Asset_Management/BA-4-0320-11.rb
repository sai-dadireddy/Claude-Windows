...
describe "BA-4-0320-11 - Leases: Finance Lease" do
...
Preview Installments for Criteria
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0320-11_complete.png"
  end
