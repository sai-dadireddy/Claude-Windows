# BA-5-0170 - Confirm Role Based Business Asset Assignments
...
describe "BA-5-0170 - Confirm Role Based Business Asset Assignments" do
  ...
  it "should complete: Confirm Role Based Business Asset Assignments" do
    ...
    # Step 4: Evidence
    screenshot as "BA-5-0170_complete.png"
  end
