# BA-4-0290-10 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)
...
# Test Steps
describe "BA-4-0290-10 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)" do
  ...
  it "should complete: Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)" do
    ...
    screenshot as "BA-4-0290-10_created.png"
  end
