...
describe "BA-4-0050-01 - Issue Asset" do
  ...
  it "should complete: Issue Asset" do
    # Step 1: Navigate
    enter search box as "1. Issue Assets"
    wait for search results
    click search result containing "1. Issue Assets"
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0050-01_complete.png"
  end
