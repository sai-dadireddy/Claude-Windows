# BA-3-0130 - Confirm Asset Specific Account Posting Rules
...
# Test Steps
describe "BA-3-0130 - Confirm Asset Specific Account Posting Rules" do
  ...
  it "should complete: Confirm Asset Specific Account Posting Rules" do
    ...
    screenshot as "BA-3-0130_complete.png"
  end
