# BA-4-0290-07 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)
...
describe "BA-4-0290-07 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)" do
  ...
  it "should complete: Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)" do
    # Step 1: Navigate
    enter search box as "Register Asset (Supplier Contract)"
    wait for search results
    click search result containing "Register Asset (Supplier Contract)"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: Register Asset (Supplier Contract)
    # Description: As Business Asset Tracking Specialist, complete asset registration information and Submit.
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0290-07_complete.png"
  end
