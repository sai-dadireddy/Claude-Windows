# BA-4-0200-17 - Register Asset from a Capital Project
...
describe "BA-4-0200-17 - Register Asset from a Capital Project" do
  ...
  it "should complete: Register Asset from a Capital Project" do
    # Step 1: Navigate
    enter search box as "17. Run Pay Complete process"
    wait for search results
    click search result containing "17. Run Pay Complete process"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: 17. Run Pay Complete process
    # Description: Run process for same Payroll Period and Pay Group as Time Entry to Capital Project
    # Sub-Task: Once Pay Calculation is complete, Run Pay Complete process

    # Step 3: Validation
    # Expected Result: Define validation criteria

    # Step 4: Evidence
    screenshot as "BA-4-0200-17_complete.png"
  end
