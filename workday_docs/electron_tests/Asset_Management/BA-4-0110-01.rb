# BA-4-0110-01 - Adjust Acquisition Cost
...
describe "BA-4-0110-01 - Adjust Acquisition Cost" do
  ...
  it "should complete: Adjust Acquisition Cost" do
    # Step 1: Navigate
    enter search box as "1. Adjust asset acquisition cost"
    wait for search results
    click search result containing "1. Adjust asset acquisition cost"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: 1. Adjust asset acquisition cost
    # Description: Adjust the acquisition cost of an asset as of the date it was acquired
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0110-01_complete.png"
  end
