# BA-4-0290-12 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)
...
describe "BA-4-0290-12 - Leases: Operating Lease Depreciation Expense (IFRS) (non multi-book)" do
...
Preview Installments for Criteria
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0290-12_complete.png"
  end
