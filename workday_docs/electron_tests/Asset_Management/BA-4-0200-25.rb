# BA-4-0200-25 - Register Asset from a Capital Project
...
describe "BA-4-0200-25 - Register Asset from a Capital Project" do
  ...
  it "should complete: Register Asset from a Capital Project" do
    # Step 1: Navigate
    enter search box as "25. Register Asset"
    wait for search results
    click search result containing "25. Register Asset"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: 25. Register Asset
    # Description: As Business Asset Tracking Specialist, complete asset registration information and Submit.
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0200-25_complete.png"
  end
