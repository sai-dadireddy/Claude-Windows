# BA-5-0140 - Confirm Trackable Spend Category Configuration
...
describe "BA-5-0140 - Confirm Trackable Spend Category Configuration" do
  ...
  it "should complete: Confirm Trackable Spend Category Configuration" do
    ...
    # Step 4: Evidence
    screenshot as "BA-5-0140_complete.png"
  end
