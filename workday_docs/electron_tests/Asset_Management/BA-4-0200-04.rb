# BA-4-0200-04 - Register Asset from a Capital Project
...
describe "BA-4-0200-04 - Register Asset from a Capital Project" do
  ...
  it "should complete: Register Asset from a Capital Project" do
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0200-04_complete.png"
  end
