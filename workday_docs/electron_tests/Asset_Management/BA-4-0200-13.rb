# BA-4-0200-13 - Register Asset from a Capital Project
...
# Test Steps
describe "BA-4-0200-13 - Register Asset from a Capital Project" do
  ...
  it "should complete: Register Asset from a Capital Project" do
    ...
    enter search box as "13. View fully burden cost in the project/financial tab/Plan"
    wait for search results
    click search result containing "13. View fully burden cost in the project/financial tab/Plan"
    ...
    verify page contains "13. View fully burden cost in the project/financial tab/Plan"

    # Step 5: Take screenshot evidence
    screenshot as "BA-4-0200-13_complete.png"
