# BA-2-0190 - Dispose of an Asset - Donation
...
describe "BA-2-0190 - Dispose of an Asset - Donation" do
  ...
  it "should complete: Dispose of an Asset - Donation" do
    # Step 1: Navigate
    enter search box as "Donate an asset"
    wait for search results
    click search result containing "Donate an asset"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: Donate an asset
    # Description: Donate an asset using a disposal type of donation.  A fair market value will be required to calculate a gain or loss
    ...
    # Step 4: Evidence
    screenshot as "BA-2-0190_complete.png"
  end
