# BA-4-0090-01 - Transfer Asset to Different Company
...
describe "BA-4-0090-01 - Transfer Asset to Different Company" do
  ...
  it "should complete: Transfer Asset to Different Company" do
    # Step 1: Navigate
    enter search box as "1. Transfer assets to different company"
    wait for search results
    click search result containing "1. Transfer assets to different company"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: 1. Transfer assets to different company
    # Description: Transfer asset to a new company with same currency
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0090-01_complete.png"
  end
