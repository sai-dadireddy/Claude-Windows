# BA-2-0200 - Dispose of an Asset - Expire
...
describe "BA-2-0200 - Dispose of an Asset - Expire" do
  ...
  it "should complete: Dispose of an Asset - Expire" do
    # Step 1: Navigate
    enter search box as "Expire an asset"
    wait for search results
    click search result containing "Expire an asset"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: Expire an asset
    # Description: Dispose of expired assets
    ...
    # Step 4: Evidence
    screenshot as "BA-2-0200_complete.png"
  end
