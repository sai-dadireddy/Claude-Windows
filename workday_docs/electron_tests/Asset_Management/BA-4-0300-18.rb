# BA-4-0300-18 - Leases: Operating Lease Multi-book
# Confidence Score: 7.5/10.0
# Functional Area: Asset Management
# Role: Accounting Operations Lead

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Review the expense recognition schedule.

# Test Steps
describe "BA-4-0300-18 - Leases: Operating Lease Multi-book" do
  ...
  it "should complete: Leases: Operating Lease Multi-book" do
    ...
    screenshot as "BA-4-0300-18_complete.png"
