# BA-4-0090-04 - Transfer Asset to Different Company
# Confidence Score: 6.5/10.0
# Functional Area: Asset Management
# Role: Business Asset Accountant

## [NEEDS SME REVIEW] - MEDIUM CONFIDENCE
## Description: Status of Transferred OUT asset should be DISPOSED  Accounting should DR Accumulated Depreciation and CR Fixed Assets
...
describe "BA-4-0090-04 - Transfer Asset to Different Company" do
  ...
  it "should complete: Transfer Asset to Different Company" do
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0090-04_complete.png"
  end
