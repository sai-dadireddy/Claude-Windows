# BA-4-0120-01 - Adjust Post Acquisition Cost
...
describe "BA-4-0120-01 - Adjust Post Acquisition Cost" do
  ...
  it "should complete: Adjust Post Acquisition Cost" do
    # Step 1: Navigate
    enter search box as "1. Adjust asset post acquisition cost"
    wait for search results
    click search result containing "1. Adjust asset post acquisition cost"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: 1. Adjust asset post acquisition cost
    # Description: Adjust the cost of an asset as of an effective date after acquisition.
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0120-01_complete.png"
  end
