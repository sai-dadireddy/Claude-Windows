# BA-4-0310-04 - Leases: Short Term Operating Lease
# Confidence Score: 6.0/10.0
# Functional Area: Asset Management
# Role: Supplier Contract Specialist

## [NEEDS SME REVIEW] - MEDIUM CONFIDENCE
## Description: Record lease expense for the short term operating lease.
...
describe "BA-4-0310-04 - Leases: Short Term Operating Lease" do
...
Preview Installments for Criteria
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0310-04_complete.png"
  end
