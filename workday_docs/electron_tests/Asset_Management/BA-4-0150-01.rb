...
describe "BA-4-0150-01 - Impair Asset" do
  ...
  it "should complete: Impair Asset" do
    # Step 1: Navigate
    enter search box as "1. Impair asset"
    wait for search results
    click search result containing "1. Impair asset"
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0150-01_complete.png"
  end
