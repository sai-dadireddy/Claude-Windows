# BA-4-0280-01 - Leases: Operating Lease Operating Expense (non multi-book)
...
# Test Steps
describe "BA-4-0280-01 - Leases: Operating Lease Operating Expense (non multi-book)" do
  ...
  it "should complete: Leases: Operating Lease Operating Expense (non multi-book)" do
    ...
    screenshot as "BA-4-0280-01_complete.png"
  end
