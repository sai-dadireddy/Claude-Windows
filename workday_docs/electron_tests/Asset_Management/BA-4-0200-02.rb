# BA-4-0200-02 - Register Asset from a Capital Project
...
describe "BA-4-0200-02 - Register Asset from a Capital Project" do
  ...
  it "should complete: Register Asset from a Capital Project" do
    ...
    # Step 4: Evidence
    screenshot as "BA-4-0200-02_complete.png"
  end
