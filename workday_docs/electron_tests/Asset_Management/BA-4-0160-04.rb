# BA-4-0160-04 - Dispose of an Asset - Sale
...
# Test Steps
describe "BA-4-0160-04 - Dispose of an Asset - Sale" do
  ...
  it "should complete: Dispose of an Asset - Sale" do
    ...
    enter search box as "1d. Sell an asset"
    wait for search results
    click search result containing "1d. Sell an asset"
    wait for page to load

    # Step 2: Execute task
    # [NEEDS SME INPUT] - Define specific actions for: 1d. Sell an asset

    # Step 3: Validation
    verify task completed successfully
    screenshot as "BA-4-0160-04_complete.png"
