# BA-4-0220-02 - Leases: Supplier Contract
# Confidence Score: 7.0/10.0
# Functional Area: Asset Management
# Role: Accounting Operations Lead

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Create supplier contracts - variable lease type

# Test Steps
describe "BA-4-0220-02 - Leases: Supplier Contract" do
  ...
  it "should complete: Leases: Supplier Contract" do
    ...
    screenshot as "BA-4-0220-02_created.png"

    # Additional Sub-Task: Verify the appropriate approvals and notifications are sent
...
# Sub-Task: Verify the appropriate approvals and notifications are sent
