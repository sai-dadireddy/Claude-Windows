# BA-2-0080 - Change Accounting for an Incorrectly Capitalized Asset
...
describe "BA-2-0080 - Change Accounting for an Incorrectly Capitalized Asset" do
  ...
  it "should complete: Change Accounting for an Incorrectly Capitalized Asset" do
    # Step 1: Navigate
    enter search box as "Change accounting"
    wait for search results
    click search result containing "Change accounting"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: Change accounting
    # Description: The task is available, regardless of the accounting treatment of the asset, as long as there are no transfers or processed depreciation.
    ...
    # Step 4: Evidence
    screenshot as "BA-2-0080_complete.png"
  end
