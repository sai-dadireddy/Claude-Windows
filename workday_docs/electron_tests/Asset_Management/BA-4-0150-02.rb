# BA-4-0150-02 - Impair Asset
# Confidence Score: 7.5/10.0
# Functional Area: Asset Management
# Role: Business Asset Accountant

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Review GL adjustments as a result of the impairment transaction

# Test Steps
describe "BA-4-0150-02 - Impair Asset" do
  ...
  it "should complete: Impair Asset" do
    ...
    screenshot as "BA-4-0150-02_complete.png"
