...
describe "BA-2-0070 - Reclassify Asset" do
  ...
  it "should complete: Reclassify Asset" do
    # Step 1: Navigate
    enter search box as "Reclassify assets"
    wait for search results
    click search result containing "Reclassify assets"
    wait for page to load

    # Step 2: Main actions
    # [SME REVIEW REQUIRED]
    # Task: Reclassify assets
    # Description: Reclassify the spend category on an in service or issued business asset
    ...
    # Step 4: Evidence
    screenshot as "BA-2-0070_complete.png"
  end
