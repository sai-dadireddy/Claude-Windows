# BA-4-0220-05 - Leases: Supplier Contract
...
## Test Information
- **Scenario ID**: BA-4-0220-05
- **Functional Area**: Asset Management
- **Role**: Business Asset Accountant
- **Task**: nan

## Manual Test Steps
1. Login as: Business Asset Accountant
2. Navigate to: nan
3. Execute: Review trackable lines for leased asset
4. Sub-Task: Inbox (BA Accountant)
