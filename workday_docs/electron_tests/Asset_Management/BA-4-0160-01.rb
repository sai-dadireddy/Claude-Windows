# BA-4-0160-01 - Dispose of an Asset - Discard
...
# Test Steps
describe "BA-4-0160-01 - Dispose of an Asset - Discard" do
  ...
  it "should complete: Dispose of an Asset - Discard" do
    ...
    enter search box as "1a. Discard an asset"
    wait for search results
    click search result containing "1a. Discard an asset"
    wait for page to load

    # Step 2: Execute task
    # [NEEDS SME INPUT] - Define specific actions for: 1a. Discard an asset

    # Step 3: Validation
    verify task completed successfully
    screenshot as "BA-4-0160-01_complete.png"
