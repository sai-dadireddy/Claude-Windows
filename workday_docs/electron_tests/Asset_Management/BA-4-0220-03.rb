# BA-4-0220-03 - Leases: Supplier Contract
# Confidence Score: 7.0/10.0
# Functional Area: Asset Management
# Role: Accounting Operations Lead

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Include prepayment when creating Variable lease

# Test Steps
describe "BA-4-0220-03 - Leases: Supplier Contract" do
  ...
  it "should complete: Leases: Supplier Contract" do
    ...
    screenshot as "BA-4-0220-03_created.png"

    # Additional Sub-Task: Verify accounting for the prepayment is included
...
# Sub-Task: Verify accounting for the prepayment is included
