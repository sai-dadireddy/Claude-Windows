# BA-4-0330-05 - Leases: Lease Amendments for Finance Lease or Operating Lease with depreciation expense accounting treatment (non multi-book)
...
# Test Steps
describe "BA-4-0330-05 - Leases: Lease Amendments for Finance Lease or Operating Lease with depreciation expense accounting treatment (non multi-book)" do
  ...
  it "should complete: Leases: Lease Amendments for Finance Lease or Operating Lease with depreciation expense accounting treatment (non multi-book)" do
    ...
    screenshot as "BA-4-0330-05_complete.png"
