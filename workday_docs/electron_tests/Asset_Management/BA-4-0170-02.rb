# BA-4-0170-02 - Reinstate Asset
# Confidence Score: 7.5/10.0
# Functional Area: Asset Management
# Role: Business Asset Accountant

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Review GL adjustments as a result of the reinstatement transaction

# Test Steps
describe "BA-4-0170-02 - Reinstate Asset" do
  ...
  it "should complete: Reinstate Asset" do
    ...
    screenshot as "BA-4-0170-02_complete.png"
