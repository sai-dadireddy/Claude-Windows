# BA-5-0190 - Worktag Usages
# Confidence Score: 8.0/10.0
# Functional Area: Asset Management
# Role: Common Finance Configurator

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Verify all required Worktag Usages have been configured for:  Business Asset Business Asset Disposal

# Test Steps
describe "BA-5-0190 - Worktag Usages" do
  ...
  it "should complete: Worktag Usages" do
    ...
    screenshot as "BA-5-0190_complete.png"
  end
