# BA-4-0200-01 - Register Asset from a Capital Project
...
# Test Steps
describe "BA-4-0200-01 - Register Asset from a Capital Project" do
  ...
  it "should complete: Register Asset from a Capital Project" do
    ...
    screenshot as "BA-4-0200-01_created.png"
  end
