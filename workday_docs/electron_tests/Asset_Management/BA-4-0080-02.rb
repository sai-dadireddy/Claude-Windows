# BA-4-0080-02 - Transfer Single Asset
# Confidence Score: 8.5/10.0
# Functional Area: Asset Management
# Role: Business Asset Tracking Specialist

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: If Transfer crossed over Worktags or Location, Accounting will be created. If it is simply worker to worker with no other impact, no Accounting is created, only changes on the Custodian tab

# Test Steps
describe "BA-4-0080-02 - Transfer Single Asset" do
  ...
  it "should complete: Transfer Single Asset" do
    ...
    screenshot as "BA-4-0080-02_complete.png"
