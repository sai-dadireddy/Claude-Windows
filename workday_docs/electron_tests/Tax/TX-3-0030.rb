# TX-3-0030 - Map 1099 misc categories to spend categories
...
# Test Steps
describe "TX-3-0030 - Map 1099 misc categories to spend categories" do
  ...
  it "should complete: Map 1099 misc categories to spend categories" do
    ...
    screenshot as "TX-3-0030_complete.png"
  end
