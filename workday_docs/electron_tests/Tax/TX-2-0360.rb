# TX-2-0360 - Create Tax Declaration - request an ad hoc approval
...
# Test Steps
describe "TX-2-0360 - Create Tax Declaration - request an ad hoc approval" do
  ...
  it "should complete: Create Tax Declaration - request an ad hoc approval" do
...
Total: 118 documents
## Results for: Tax Create Tax Declaration - request an ad hoc approval Create Tax Declaration Run
