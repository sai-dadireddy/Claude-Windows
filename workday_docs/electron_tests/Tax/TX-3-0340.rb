# TX-3-0340 - Create a 1099 miscellaneous adjustment - deny prior to final approval
...
# Test Steps
describe "TX-3-0340 - Create a 1099 miscellaneous adjustment - deny prior to final approval" do
  ...
  it "should complete: Create a 1099 miscellaneous adjustment - deny prior to final approval" do
    ...
    screenshot as "TX-3-0340_created.png"
  end
