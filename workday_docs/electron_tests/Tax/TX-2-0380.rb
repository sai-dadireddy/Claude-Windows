# TX-2-0380 - Create Tax Declaration - deny prior to final approval
...
# Test Steps
describe "TX-2-0380 - Create Tax Declaration - deny prior to final approval" do
...
Total: 118 documents
## Results for: Tax Create Tax Declaration - deny prior to final approval Create Tax Declaration Run

### 1. Kb Hcm Terminate Employee (score: 8)
