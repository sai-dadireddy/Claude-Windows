# TX-3-0380 - Create Tax Declaration - send back prior to final approval
...
# Test Steps
describe "TX-3-0380 - Create Tax Declaration - send back prior to final approval" do
  ...
  it "should complete: Create Tax Declaration - send back prior to final approval" do
    ...
    screenshot as "TX-3-0380_created.png"
  end
