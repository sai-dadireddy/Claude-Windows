# TX-2-0110 - Assign Items to Transaction Tax Item Group
...
# Test Steps
describe "TX-2-0110 - Assign Items to Transaction Tax Item Group" do
  ...
  it "should complete: Assign Items to Transaction Tax Item Group" do
    ...
    screenshot as "TX-2-0110_complete.png"
  end
