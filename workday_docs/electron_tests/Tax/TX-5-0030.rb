# TX-5-0030 - Validate 1099 misc categories to spend categories
...
# Test Steps
describe "TX-5-0030 - Validate 1099 misc categories to spend categories" do
  ...
  it "should complete: Validate 1099 misc categories to spend categories" do
    ...
    screenshot "#TX-5-0030_verification"
  end
...
Total: 118 documents
## Results for: Tax Validate 1099 misc categories to spend categories View 1099 Configuration
