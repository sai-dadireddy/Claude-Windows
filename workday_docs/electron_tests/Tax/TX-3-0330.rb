# TX-3-0330 - Create a 1099 miscellaneous adjustment - send back prior to final approval
...
# Test Steps
describe "TX-3-0330 - Create a 1099 miscellaneous adjustment - send back prior to final approval" do
  ...
  it "should complete: Create a 1099 miscellaneous adjustment - send back prior to final approval" do
    ...
    screenshot as "TX-3-0330_created.png"
  end
