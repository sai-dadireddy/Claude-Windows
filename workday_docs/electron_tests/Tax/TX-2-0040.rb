# TX-2-0040 - Map 1042-s incomes codes to spend categories
...
# Test Steps
describe "TX-2-0040 - Map 1042-s incomes codes to spend categories" do
  ...
  it "should complete: Map 1042-s incomes codes to spend categories" do
    ...
    screenshot as "TX-2-0040_complete.png"
  end
