# TX-3-0370 - Create Tax Declaration - request an ad hoc approval
...
# Test Steps
describe "TX-3-0370 - Create Tax Declaration - request an ad hoc approval" do
  ...
  it "should complete: Create Tax Declaration - request an ad hoc approval" do
    ...
    screenshot as "TX-3-0370_created.png"
  end
