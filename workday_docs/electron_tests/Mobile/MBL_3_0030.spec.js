...
test.describe('Mobile - MBL-3-0030', () => {
  let api;
  ...
  test('Security/ Remote access setup', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'MBL-3-0030',
...
Mobile Usage - iPhone
    ...
    // 2. Execute: Users with access to these domains in the System functional area can sign in to Workday on a mobile device:
Mobile Usage - Android
Mobile Usage - iPad
Mobile Usage - iPhone
 ...
 *
 * Task Details:
 * Users with access to these domains in the System functional area can sign in to Workday on a mobile device:
Mobile Usage - Android
Mobile Usage - iPad
Mobile Usage - iPhone
 *
