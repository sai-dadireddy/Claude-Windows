...
test.describe('Mobile - MBL-5-0030', () => {
  let api;
  ...
  test('Validate Mobile Notification setup', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'MBL-5-0030',
    ...
    // 2. Execute: Edit Tenant Setup – Notifications > Mobile App Notification Settings section and Notification Delivery Settings section
 ...
 *
 * Task Details:
 * Edit Tenant Setup – Notifications > Mobile App Notification Settings section and Notification Delivery Settings section
 *
 * Step Details:
