...
test.describe('Mobile - MBL-5-0010', () => {
  let api;
...
Edit Tenant Setup - Security > Mobile Authentication section
    ...
    // 2. Execute: Edit Tenant Setup - System > Mobile section
Edit Tenant Setup - Security > Mobile Authentication section
 ...
 *
 * Task Details:
 * Edit Tenant Setup - System > Mobile section
Edit Tenant Setup - Security > Mobile Authentication section
 *
 * Step Details:
