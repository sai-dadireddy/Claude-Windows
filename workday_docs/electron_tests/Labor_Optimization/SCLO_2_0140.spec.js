/**
 * Test: Labor Demand Preferred Schedule Tags
 * Scenario ID: SCLO-2-0140
...
test.describe('Labor Optimization - SCLO-2-0140', () => {
  let api;
  ...
  test('Labor Demand Preferred Schedule Tags', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'SCLO-2-0140',
