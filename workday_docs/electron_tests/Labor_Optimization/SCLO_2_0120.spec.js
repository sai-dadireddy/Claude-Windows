/**
 * Test: Labor Demand Preferred Days & Times
 * Scenario ID: SCLO-2-0120
...
test.describe('Labor Optimization - SCLO-2-0120', () => {
  let api;
  ...
  test('Labor Demand Preferred Days & Times', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'SCLO-2-0120',
