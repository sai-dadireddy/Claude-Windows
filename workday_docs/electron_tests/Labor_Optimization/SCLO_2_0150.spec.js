/**
 * Test: Labor Demand Schedule Tag Values
 * Scenario ID: SCLO-2-0150
...
test.describe('Labor Optimization - SCLO-2-0150', () => {
  let api;
  ...
  test('Labor Demand Schedule Tag Values', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'SCLO-2-0150',
