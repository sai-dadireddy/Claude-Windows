/**
 * Test: Labor Demand vs Schedule Hours Variance
 * Scenario ID: SCLO-2-0090
...
test.describe('Labor Optimization - SCLO-2-0090', () => {
  let api;
  ...
  test('Labor Demand vs Schedule Hours Variance', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'SCLO-2-0090',
