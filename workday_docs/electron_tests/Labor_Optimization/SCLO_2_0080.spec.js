...
test.describe('Labor Optimization - SCLO-2-0080', () => {
  let api;
  ...
  test('Demand Period Length on the HLSO', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'SCLO-2-0080',
    ...
    // 2. Execute: Search: Schedule Workers
