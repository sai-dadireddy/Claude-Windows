...
test.describe('Labor Optimization - SCLO-4-0010', () => {
  let api;
  ...
  test('Compensation Change Business Process', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'SCLO-4-0010',
    ...
    // 2. Execute: Compensation Change Business Process
