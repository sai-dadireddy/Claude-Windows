/**
 * Test: Audit Survey Schedules - Email
 * Scenario ID: EMPVCE-3-0110
...
test.describe('Peakon - EMPVCE-3-0110', () => {
  let api;
  ...
  test('Audit Survey Schedules - Email', async () => {
    test.skip(false, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-3-0110',
