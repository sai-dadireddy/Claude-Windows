...
test.describe('Peakon - EMPVCE-4-0040', () => {
  let api;
  ...
  test('Dashboard Access - Analysis', async () => {
    test.skip(false, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-4-0040',
      timestamp: new Date().toISOString()
    };

    // TASK: Click Analysis in the top horizontal menu
    // STEP: Verify available access via vertical menu on the left
 ...
 *
 * Task Details:
 * Click Analysis in the top horizontal menu
 *
 * Step Details:
 * Verify available access via vertical menu on the left
 */
