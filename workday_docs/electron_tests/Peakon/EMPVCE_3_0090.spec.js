/**
 * Test: Audit Survey Schedules
 * Scenario ID: EMPVCE-3-0090
...
test.describe('Peakon - EMPVCE-3-0090', () => {
  let api;
  ...
  test('Audit Survey Schedules', async () => {
    ...
    // 2. Execute: Administration > Survey > Schedules
