/**
 * Test: Audit Survey Schedules - Attributes
 * Scenario ID: EMPVCE-3-0130
...
test.describe('Peakon - EMPVCE-3-0130', () => {
  let api;
  ...
  test('Audit Survey Schedules - Attributes', async () => {
    test.skip(false, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-3-0130',
