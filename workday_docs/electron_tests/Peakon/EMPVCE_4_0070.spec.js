...
test.describe('Peakon - EMPVCE-4-0070', () => {
  let api;
  ...
  test('Context Switcher', async () => {
    ...
    // 2. Execute: Expand context switcher on top left side. Select another context available in the modal view that opens op, or use the search to find a context (i.e. name of a direct report)
 ...
 *
 * Task Details:
 * Expand context switcher on top left side. Select another context available in the modal view that opens op, or use the search to find a context (i.e. name of a direct report)
 *
 * Step Details:
