...
test.describe('Peakon - EMPVCE-3-0230', () => {
  let api;
  ...
  test('Audit Resources', async () => {
    ...
    // 2. Execute: Administration > Improve > Resources
 ...
 *
 * Task Details:
 * Administration > Improve > Resources
 *
 * Step Details:
