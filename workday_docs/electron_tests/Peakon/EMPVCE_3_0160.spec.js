...
test.describe('Peakon - EMPVCE-3-0160', () => {
  let api;
  ...
  test('Audit Questions', async () => {
    ...
    // 2. Execute: Administration > Survey > Questions
 ...
 *
 * Task Details:
 * Administration > Survey > Questions
 *
 * Step Details:
