...
test.describe('Peakon - EMPVCE-4-0060', () => {
  let api;
  ...
  test('Dashboard Access - Personal Dashboard', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-4-0060',
    ...
    // 2. Execute: Click Personal Dashboard icon in the top bar, left from the notifications icon
 ...
 *
 * Task Details:
 * Click Personal Dashboard icon in the top bar, left from the notifications icon
 *
 * Step Details:
