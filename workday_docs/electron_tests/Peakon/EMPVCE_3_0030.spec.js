...
test.describe('Peakon - EMPVCE-3-0030', () => {
  let api;
  ...
  test('Audit Attributes and Segments', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-3-0030',
    ...
    // 2. Execute: Administration > Company > Attributes
 ...
 *
 * Task Details:
 * Administration > Company > Attributes
 *
 * Step Details:
