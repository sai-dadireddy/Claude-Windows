...
test.describe('Peakon - EMPVCE-3-0260', () => {
  let api;
  ...
  test('Audit Integrations', async () => {
    ...
    // 2. Execute: Administration > Company > Integrations
 ...
 *
 * Task Details:
 * Administration > Company > Integrations
 *
 * Step Details:
