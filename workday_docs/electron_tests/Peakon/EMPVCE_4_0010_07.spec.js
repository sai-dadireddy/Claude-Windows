...
test.describe('Peakon - EMPVCE-4-0010-07', () => {
  let api;
  ...
  test('Test survey', async () => {
    ...
    // 2. Execute: 7. Access survey via the Peakon mobile app
 ...
 *
 * Task Details:
 * 7. Access survey via the Peakon mobile app
 *
 * Step Details:
