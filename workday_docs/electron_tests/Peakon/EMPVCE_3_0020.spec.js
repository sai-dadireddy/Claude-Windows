...
test.describe('Peakon - EMPVCE-3-0020', () => {
  let api;
  ...
  test('Audit Access Control Groups', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-3-0020',
    ...
    // 2. Execute: Administration > Company > Access Control
 ...
 *
 * Task Details:
 * Administration > Company > Access Control
 *
 * Step Details:
