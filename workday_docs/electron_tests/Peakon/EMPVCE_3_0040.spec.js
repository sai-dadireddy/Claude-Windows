...
test.describe('Peakon - EMPVCE-3-0040', () => {
  let api;
  ...
  test('Audit Branding', async () => {
    ...
    // 2. Execute: Administration > Company > Branding
 ...
 *
 * Task Details:
 * Administration > Company > Branding
 *
 * Step Details:
