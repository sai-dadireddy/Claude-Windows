/**
 * Test: Audit Account - Consent Request
 * Scenario ID: EMPVCE-3-0080
...
test.describe('Peakon - EMPVCE-3-0080', () => {
  let api;
  ...
  test('Audit Account - Consent Request', async () => {
    test.skip(false, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-3-0080',
 ...
 *
 * Task Details:
 * Administration > Company > Account
 *
 * Step Details:
 * Consent Request
 */
