/**
 * Test: Audit Data Settings - Benchmark
 * Scenario ID: EMPVCE-3-0210
...
test.describe('Peakon - EMPVCE-3-0210', () => {
  let api;
  ...
  test('Audit Data Settings - Benchmark', async () => {
    test.skip(false, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-3-0210',
