/**
 * Test: Audit Survey Schedules - Frequency
 * Scenario ID: EMPVCE-3-0100
...
test.describe('Peakon - EMPVCE-3-0100', () => {
  let api;
  ...
  test('Audit Survey Schedules - Frequency', async () => {
    test.skip(false, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'EMPVCE-3-0100',
