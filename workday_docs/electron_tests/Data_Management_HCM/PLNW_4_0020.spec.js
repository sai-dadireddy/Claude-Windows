/**
 * Test: Run Task - Levels
 * Scenario ID: PLNW-4-0020
...
test.describe('PLN - Data Management (HCM) - PLNW-4-0020', () => {
  let api;
  ...
  test('Run Task - Levels', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'PLNW-4-0020',
      timestamp: new Date().toISOString()
    };

    // MANUAL TEST STEPS:
    // Task: -Go to Integration > Run Tasks
-Run all tasks related to the creation of levels
-Confirm that the task successfully completes at %100
-Confirm the the correct levels have been created in the correct hierarchy.
