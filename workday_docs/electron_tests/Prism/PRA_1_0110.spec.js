...
test.describe('Prism - PRA-1-0110', () => {
  let api;
  ...
  test('Review Role Based security group permissions', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'PRA-1-0110',
    ...
    // 2. Execute: Go to: Data Catalog > Related Actions > Share
 ...
 *
 * Task Details:
 * Go to: Data Catalog > Related Actions > Share
 *
 * Step Details:
