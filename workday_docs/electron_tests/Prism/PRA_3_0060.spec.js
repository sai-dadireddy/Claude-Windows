...
test.describe('Prism - PRA-3-0060', () => {
  let api;
  ...
  test('Run Reports/Discovery Boards/Dashboards', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'PRA-3-0060',
