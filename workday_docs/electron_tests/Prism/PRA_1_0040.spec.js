...
test.describe('Prism - PRA-1-0040', () => {
  let api;
  ...
  test('Test SFTP integrations', async () => {
    ...
    // 2. Execute: View Dataset Integration Details
 ...
 *
 * Task Details:
 * View Dataset Integration Details
 *
 * Step Details:
