...
test.describe('Prism - PRA-5-0020', () => {
  let api;
  ...
  test('Review owners publishing schedules', async () => {
    test.skip(true, 'Manual testing required - no task/step defined');

    // TEST SETUP
    const testData = {
      scenarioId: 'PRA-5-0020',
    ...
    // 2. Execute: View Dataset> View Schedule
