# CC-5-0140 - Verify Revenue Recognition Schedule Templates
...
# Test Steps
describe "CC-5-0140 - Verify Revenue Recognition Schedule Templates" do
  ...
  it "should complete: Verify Revenue Recognition Schedule Templates" do
    ...
    screenshot as "CC-5-0140_complete.png"
  end
