# CC-5-0160 - Confirm Role Based Customer Contract Assignments Assignments
...
describe "CC-5-0160 - Confirm Role Based Customer Contract Assignments Assignments" do
  ...
  it "should complete: Confirm Role Based Customer Contract Assignments Assignments" do
    ...
    # Step 4: Evidence
    screenshot as "CC-5-0160_complete.png"
  end
