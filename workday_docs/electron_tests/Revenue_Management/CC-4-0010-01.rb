# CC-4-0010-01 - Create, Change and Amend Customer Contract
# Confidence Score: 7.5/10.0
# Functional Area: Revenue Management
# Role: Customer Contract Specialist

## AUTOMATED TEST - HIGH CONFIDENCE
## Description: Create Customer Contract without deferred revenue. Ensure customer contract routes successfully through the BP: Customer Contract Event. Default is Initiation only.

# Test Steps
describe "CC-4-0010-01 - Create, Change and Amend Customer Contract" do
  ...
  it "should complete: Create, Change and Amend Customer Contract" do
    ...
    enter search box as "1. Create Customer Contract"
    wait for search results
    click search result containing "1. Create Customer Contract"
    ...
    screenshot as "CC-4-0010-01_created.png"
