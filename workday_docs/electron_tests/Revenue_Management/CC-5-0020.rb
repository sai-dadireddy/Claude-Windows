# CC-5-0020 - Verify Revenue Categories and Hierarchies
...
# Test Steps
describe "CC-5-0020 - Verify Revenue Categories and Hierarchies" do
  ...
  it "should complete: Verify Revenue Categories and Hierarchies" do
    ...
    screenshot as "CC-5-0020_complete.png"
  end
