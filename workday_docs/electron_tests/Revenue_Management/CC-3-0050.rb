# CC-3-0050 - Verify Customer Contract Amendment Types
...
# Test Steps
describe "CC-3-0050 - Verify Customer Contract Amendment Types" do
  ...
  it "should complete: Verify Customer Contract Amendment Types" do
    ...
    navigate_to_task "Maintain Customer Contract Amendment Types"
    wait_for_page_load
...
Total: 118 documents
## Results for: Revenue Management Verify Customer Contract Amendment Types Maintain Customer Contract Amendment Types
