# CC-3-0170 - Confirm User Based Customer Contract Assignments Assignments
...
# Test Steps
describe "CC-3-0170 - Confirm User Based Customer Contract Assignments Assignments" do
  ...
  it "should complete: Confirm User Based Customer Contract Assignments Assignments" do
    ...
    screenshot as "CC-3-0170_complete.png"
  end
