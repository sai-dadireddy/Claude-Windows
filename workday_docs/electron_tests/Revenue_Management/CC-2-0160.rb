...
describe "CC-2-0160 - Review Business Process for Billing Schedule Event; Discuss any required modifications." do
  ...
  it "should complete: Review Business Process for Billing Schedule Event; Discuss any required modifications." do
    ...
    navigate_to_task "bp: Billing Schedule Event"
    wait_for_page_load
...
Total: 118 documents
## Results for: Revenue Management Review Business Process for Billing Schedule Event; Discuss any required modifications. bp: Billing Schedule Event
