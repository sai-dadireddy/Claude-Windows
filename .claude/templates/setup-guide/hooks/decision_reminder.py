...
Command: ~/.claude/scripts/memory_manager.py save-memory PROJECT decision "WHAT_WAS_SET_UP"
    ...
    print(f"💾 Memory hint written to ~/.claude/hints/current.txt")
    sys.exit(0)
